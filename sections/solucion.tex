...
Donde \(K\) es la ganancia del sensor mencionada anteriormente. Este valor debe determinarse aplicando una corriente conocida en la entrada del sensor y observando el valor medido en Simulink para realizar el despeje correspondiente. En la práctica, se utilizó un factor de compensanción K del siguente valor:\\

\begin{equation}
	K_{Real} = \frac{0.6}{1.33}
	\label{eq:Kreal}
\end{equation}
